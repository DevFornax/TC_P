...
//             className="bg-[#6c63ff] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#5951e6] transition duration-200 ease-in-out"
//           >
//             Submit
//           </button>
//         </div>
...
const handleSubmit = async () => {
  ...
  localStorage.setItem("payload", JSON.stringify(payload));
  navigate("/sld-view", { state: payload }); // No API call here
};
